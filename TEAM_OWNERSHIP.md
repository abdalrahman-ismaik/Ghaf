...
| `/root` — contract and integration                         | `PRODUCT.md`, `PROTOTYPE_LIMITATIONS.md`, `DESIGN.md`, `DEMO_RUNBOOK.md`, `TEAM_OWNERSHIP.md`, Feature 003 `spec.md`, `plan.md`, `tasks.md`, `data-model.md`, contracts, design-intake gates/specifications, shared models/store/services/i18n/configuration, `tests/r002b-feature-flags.test.ts`, route integration, exact staging, validation, and commits | Serialize shared files, keep flags default-off, preserve all R002a behavior, and record every gate truthfully                                                                               |
...
| Future achievement writer                                  | New achievement/Impact Path domain modules and focused test files only, assigned after progression interfaces stabilize                                                                                                                                                                                                                                      | RED/GREEN handoff with no route, store, fixture, resource, or configuration edit                                                                                                            |
