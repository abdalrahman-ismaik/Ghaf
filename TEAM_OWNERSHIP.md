...
| `/root` — reusable presentation                                                         | `src/components/family-growth/{SyntheticAccessPanel.tsx,FamilyRewardPanel.tsx,FamilyLeaguePanel.tsx}`                                                                                                                                                                                                                                                                                       | Parent and Child views use the existing tokens, bilingual resources, direct labels, logical layout, accessible controls, and truthful synthetic/private disclosures                                                   |
