...
export const TASK_TEMPLATES: readonly TaskTemplate[] = [
  ...
  template({
    ...
    categoryId: 'faith_gratitude',
    landscapeId: 'sidr',
    title: text('مشاركة لحظة امتنان يختارها الطفل', 'Share one gratitude moment the Child chooses'),
    positiveAction: text(
      'اختر شيئاً واحداً تقدّره وشاركه إن رغبت.',
      'Choose one thing you appreciate and share it if you wish.',
    ),
    recognitionMode: 'recognition_only',
    routinePhase: 'not_applicable',
    recurrence: 'once',
  ...
  template({
    ...
    categoryId: 'roots_kinship',
    landscapeId: 'ghaf',
    title: text('الاتصال بقريب يختاره وليّ الأمر', 'Call a relative chosen by the Parent'),
    positiveAction: text(
      'اختر مع وليّ الأمر تحية أو سؤالاً قصيراً لقريب يرغب في المشاركة.',
      'Choose a short greeting or question with the Parent for a willing relative.',
    ),
    recognitionMode: 'recognition_only',
    routinePhase: 'not_applicable',
    recurrence: 'recurrent',
  ...
  template({
    ...
    categoryId: 'roots_kinship',
    landscapeId: 'ghaf',
    title: text('الاستماع إلى قصة عائلية قصيرة', 'Listen to a short family story'),
    positiveAction: text(
      'استمع إلى قصة يختار قريب مشاركتها، مع إمكانية التوقف في أي وقت.',
  ...
  template({
    ...
    categoryId: 'home_responsibility',
    landscapeId: 'samar',
    title: text('ترتيب الكتب والأقلام', 'Put books and pens in their places'),
    positiveAction: text(
      'أعد الكتب والأقلام إلى أماكنها المتفق عليها.',
  ...
  template({
    ...
    landscapeId: 'mangrove',
    title: text(
      'إطفاء الأنوار غير المستخدمة مع شخص بالغ',
      'Switch off unused lights with an adult',
    ),
    positiveAction: text(
      'تفقد غرفة واحدة مع شخص بالغ وأطفئ الضوء غير المطلوب.',
  ...
  template({
    ...
    categoryId: 'green_impact',
    landscapeId: 'mangrove',
    title: text('استخدام زجاجة ماء قابلة لإعادة الاستخدام', 'Prepare a reusable water bottle'),
    positiveAction: text(
      'اطلب من شخص بالغ فحص زجاجة سليمة ثم جهزها للاستخدام.',
  ...
  template({
    ...
    categoryId: 'food_hospitality',
    landscapeId: 'date_palm',
    title: text('ترتيب المناديل والملاعق الباردة', 'Arrange napkins and cool utensils'),
    positiveAction: text(
      'رتّب مواد آمنة وغير قابلة للكسر يحددها وليّ الأمر.',
  ...
  template({
    id: 'HE01',
    categoryId: 'heritage_etiquette',
    landscapeId: 'ghaf',
    title: text(
      'اختيار تحية مناسبة مع وليّ الأمر',
      'Choose an appropriate greeting with the Parent',
    ),
    positiveAction: text(
      'تدرّب على تحية واحدة من الخيارات التي يراجعها وليّ الأمر.',
      'Practise one greeting from options reviewed by the Parent.',
    ),
    recognitionMode: 'recognition_only',
    routinePhase: 'not_applicable',
    recurrence: 'once',
  ...
  template({
    ...
    categoryId: 'heritage_etiquette',
    landscapeId: 'ghaf',
    title: text('الاستماع إلى المتحدث في المجلس', 'Practise listening to a speaker in the majlis'),
    positiveAction: text(
      'اختر مع وليّ الأمر وقتاً قصيراً للاستماع من دون مقاطعة.',
      'Choose a short time with the Parent to listen without interrupting.',
    ),
    recognitionMode: 'recognition_only',
    routinePhase: 'not_applicable',
    recurrence: 'recurrent',
  ...
  template({
    ...
    categoryId: 'heritage_etiquette',
    landscapeId: 'ghaf',
    title: text('سؤال شخص بالغ عن غرض تراثي', 'Ask an adult about one heritage object'),
    positiveAction: text(
      'اختر غرضاً آمناً واسأل شخصاً بالغاً عن قصته أو استخدامه.',
  ...
  template({
    ...
    categoryId: 'kindness_community',
    landscapeId: 'samar',
    title: text('كتابة رسالة شكر قصيرة', 'Write a short thank-you note'),
    positiveAction: text(
      'اكتب أو املِ رسالة شكر لشخص تختاره.',
      'Write or dictate a thank-you note to someone you choose.',
    ),
    recognitionMode: 'recognition_only',
    routinePhase: 'not_applicable',
    recurrence: 'once',
  ...
  template({
    ...
    categoryId: 'kindness_community',
    landscapeId: 'samar',
    title: text('اختيار مساعدة صغيرة في المنزل', 'Choose one small way to help at home'),
    positiveAction: text(
      'اسأل عمّا يحتاج إلى مساعدة واختر خطوة آمنة يمكنك إنجازها.',
  ...
  template({
    ...
    categoryId: 'learning_wellbeing',
    landscapeId: 'sidr',
    title: text('تجهيز مكان هادئ للتعلّم', 'Prepare a calm learning space'),
    positiveAction: text(
      'ضع الأدوات المطلوبة في مكان مناسب يختاره وليّ الأمر.',
  ...
  template({
    ...
    categoryId: 'learning_wellbeing',
    landscapeId: 'sidr',
    title: text('تقسيم مشروع إلى ثلاث خطوات', 'Break one project into three steps'),
    positiveAction: text(
      'اكتب أو سجّل ثلاث خطوات قصيرة بمساعدة مسموحة.',
      'Write or record three short steps with permitted help.',
    ),
    recognitionMode: 'standard',
    routinePhase: 'acquisition',
    recurrence: 'once',
