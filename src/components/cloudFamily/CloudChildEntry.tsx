    ...
    <AccessScreen
      ...
      header={
        <AccessHeader
          ...
          title={t('cloudFamily.access.title')}
          direction={direction}
          language={locale}
        />
      }
      ...
      <View style={styles.root}>
        ...
        {error ? (
          <StatusBanner
            ...
            language={locale}
            tone="error"
            message={t(`cloudFamily.errors.${error}`)}
          />
        ) : null}
        {userId ? (
          <CloudFamilyBoundary
          ...
          <>
            <Text brand color="deepForest" variant="parentHero">
              {t('cloudFamily.access.title')}
            </Text>
            <Text brand>{t('cloudFamily.access.body')}</Text>
            <AccessTextField
              label={t('cloudFamily.access.token')}
              language={locale}
              direction="ltr"
              autoCapitalize="none"
              autoCorrect={false}
