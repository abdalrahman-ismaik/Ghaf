...
- Generator: synthetic image generation, using the preserved v1 synthetic father portrait as the
...
The image-edit reference was `parent-access-emirati.jpg`, whose generation history remains
preserved below.

## Transformations and inspection

1. Generated once from the approved synthetic composition brief and v1 local reference.
...
The v1 file is not overwritten or deleted so its checksum, subject count, and audit trail remain
truthful.
