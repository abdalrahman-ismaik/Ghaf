# Emirati Child Access Portrait Provenance
...
The user explicitly requested a generated image of a boy and girl in Emirati traditional clothes
for Child login. These are fictional presentation candidates and are intentionally separate from
the tree-avatar profile buttons. They do not depict Salem or Alya, support face login, establish
nationality, or claim that one appearance represents every Emirati Child. The image contains no
