...
- [ ] T016 A: Inspect/release coherent worker commits, integrate preserving authorship, run typecheck/lint/format/full suite once per meaningful source candidate; publish exact source/flag/check receipt in workstreams/a-contract.md and AI assistance ledger.
