...
| `src/components/access/BotanicalAvatar.tsx`                                                                 | Profile identity                                      | Protect unchanged                                                             | Child avatar selection must not become product branding                      |
...
| `src/components/r002a/child/ChildTaskHero.tsx`                                                              | Task illustration                                     | Protect unchanged                                                             | Tree glyph explains task/growth context                                      |
...
| `src/components/family-growth/GardenLandscape.tsx`                                                          | Landscape artwork                                     | Protect unchanged                                                             | Garden stage art is product state, not a logo                                |
| `src/components/family-growth/FamilyCanopy.tsx`                                                             | Family canopy artwork                                 | Protect unchanged                                                             | Canopy visual communicates earned family progress                            |
| `src/components/family-growth/CircleProgress.tsx`                                                           | Private community progress                            | Protect unchanged                                                             | Tree visual is a stateful product illustration                               |
...
| `src/components/r002b/LearningScreens.tsx`                                                                  | Educational artwork                                   | Protect unchanged                                                             | Learning art must retain its teaching role                                   |
| `src/components/r002b/RevealBundleScreen.tsx`                                                               | Reward/consequence artwork                            | Protect unchanged                                                             | Illustration represents committed outcomes                                   |
| `src/components/r002b/PrivateLeagueScreen.tsx`                                                              | League hero and tree avatars                          | Protect unchanged                                                             | Private League identity must not be overwritten                              |
| `src/components/r002b/SharedGrowthScreens.tsx`                                                              | Anonymous community artwork                           | Protect unchanged                                                             | Shared Growth visuals are not Ghaf product marks                             |
| `assets/images/**` and `assets/demo/**`                                                                     | Prepared product content                              | Protect unchanged                                                             | No genuine brand placeholder was found                                       |
