...
vi.mock('@/components/companion/CompanionPortrait', () => ({ CompanionPortrait: () => null }));
vi.mock('@/components/familyMessaging/MessagingEntry', () => ({ MessagingEntry: () => null }));
...
function prepare(ageBand: AgeBand, locale: LocaleCode) {
  ...
  const directory = createLocalFamilyRecord({
    ...
    familyConnections: {
      primaryGuardianName: 'Prepared Parent',
